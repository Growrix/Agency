...
name: mkt-repurposer
description: >-
  Blog to social, email, video scripts, lead magnets. AG-GRO-REPURPOSE-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Content Repurposer

**AG-GRO-REPURPOSE-001** — Marketing OS specialist under `@marketing-cmo`.
