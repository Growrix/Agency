...
1. [references/ai-bos-binding.md](references/ai-bos-binding.md) — **required** (`PRJ-TMPL-NEXT-001` / rule 78)
2. `.cursor/brain/lane-router.yaml` + `.cursor/brain/migration-brain.md`
