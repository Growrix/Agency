---
name: mkt-brand-guardian
description: >-
  Brand consistency review across outputs. AG-GRO-BRAND-GUARD-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Brand Guardian

**AG-GRO-BRAND-GUARD-001** — Marketing OS specialist under `@marketing-cmo`.
