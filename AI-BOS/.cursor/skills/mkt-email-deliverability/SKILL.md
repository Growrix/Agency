---
name: mkt-email-deliverability
description: >-
  Deliverability, SPF/DKIM guidance, list hygiene. AG-GRO-EMAIL-DELIV-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Email Deliverability

**AG-GRO-EMAIL-DELIV-001** — Marketing OS specialist under `@marketing-cmo`.
