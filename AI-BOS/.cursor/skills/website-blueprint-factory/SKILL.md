...
1. [references/ai-bos-binding.md](references/ai-bos-binding.md) — **required** (`PRJ-BP-WEB-001` / rule 79)
2. `.cursor/execution/template-tasks.md`
3. Stage agents `AG-BP-STG-001` … `AG-BP-STG-012` via `AG-BP-DIR-001`
