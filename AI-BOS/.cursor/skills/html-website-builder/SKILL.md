...
1. [references/ai-bos-binding.md](references/ai-bos-binding.md) — **required** (`PRJ-TMPL-HTML-001` / rule 77)
2. `.cursor/brain/lane-router.yaml` + `.cursor/brain/template-brain.md`
