...
name: mkt-experiment
description: >-
  A/B tests, hypotheses, results. AG-GRO-EXPERIMENT-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Experiment Designer

**AG-GRO-EXPERIMENT-001** — Marketing OS specialist under `@marketing-cmo`.
