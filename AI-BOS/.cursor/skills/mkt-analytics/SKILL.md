...
name: mkt-analytics
description: >-
  GA4, Search Console, CRM analytics interpretation. AG-GRO-ANALYTICS-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Marketing Analytics

**AG-GRO-ANALYTICS-001** — Marketing OS specialist under `@marketing-cmo`.

## Read First

1. `HB-GRO-ANALYTICS-001`
