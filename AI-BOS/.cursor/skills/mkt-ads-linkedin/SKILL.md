---
name: mkt-ads-linkedin
description: >-
  LinkedIn B2B ad campaigns. AG-GRO-ADS-LI-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# LinkedIn Ads

**AG-GRO-ADS-LI-001** — Marketing OS specialist under `@marketing-cmo`.
