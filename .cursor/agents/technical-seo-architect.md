...
description: Reusable Technical SEO Architect for Build Mode and Audit Mode. Use for technical SEO audits, greenfield SEO architecture, Next.js SEO reviews, migrations, crawlability, indexability, metadata, schema, canonicals, robots, sitemaps, Core Web Vitals, security headers, accessibility, CI/CD SEO gates, monitoring, and AI-executable SEO tasks.
model: inherit
---
...
For future projects, copy this adapter to `.cursor/agents/technical-seo-architect.md` and copy the `Ongoing DOCS/Technical_SEO` handbook folder, or update the source paths above to that project's equivalent Technical SEO handbook.
