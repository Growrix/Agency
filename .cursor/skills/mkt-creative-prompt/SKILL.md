---
name: mkt-creative-prompt
description: >-
  AI image/video generation prompts. AG-GRO-PROMPT-CREATIVE-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Creative Prompt Engineer

**AG-GRO-PROMPT-CREATIVE-001** — Marketing OS specialist under `@marketing-cmo`.
