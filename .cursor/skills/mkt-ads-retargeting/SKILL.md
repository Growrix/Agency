---
name: mkt-ads-retargeting
description: >-
  Retargeting audiences and sequences. AG-GRO-ADS-RETARGET-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Retargeting

**AG-GRO-ADS-RETARGET-001** — Marketing OS specialist under `@marketing-cmo`.
