...
description: >-
  ICP, personas, buyer journey, VoC. AG-GRO-INTEL-CUST-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Customer Research

**AG-GRO-INTEL-CUST-001** — Marketing OS specialist under `@marketing-cmo`.
