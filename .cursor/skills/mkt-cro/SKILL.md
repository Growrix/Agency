...
name: mkt-cro
description: >-
  Landing page CRO, CTAs, forms, trust. AG-GRO-CRO-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# CRO Specialist

**AG-GRO-CRO-001** — Marketing OS specialist under `@marketing-cmo`.
