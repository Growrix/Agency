---
name: mkt-creative-brief
description: >-
  Ad layouts, thumbnails, carousel briefs. AG-GRO-CREATIVE-BRIEF-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Creative Brief Planner

**AG-GRO-CREATIVE-BRIEF-001** — Marketing OS specialist under `@marketing-cmo`.
