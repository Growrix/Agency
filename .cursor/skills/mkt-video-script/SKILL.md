---
name: mkt-video-script
description: >-
  Reels, YouTube, ad, explainer scripts. AG-GRO-VIDEO-SCRIPT-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# Video Script Writer

**AG-GRO-VIDEO-SCRIPT-001** — Marketing OS specialist under `@marketing-cmo`.
