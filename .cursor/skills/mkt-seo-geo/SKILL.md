...
name: mkt-seo-geo
description: >-
  GEO, entity SEO, AI citation optimization. AG-GRO-SEO-GEO-001. Marketing OS advisory — no coding, no ad spend.
disable-model-invocation: true
---

# AI Search / GEO

**AG-GRO-SEO-GEO-001** — Marketing OS specialist under `@marketing-cmo`.

## Read First

1. `HB-GRO-SEO-GEO-001`
