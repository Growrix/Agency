...
export const BLOG_AUTHORS: Record<string, BlogAuthor> = {
  noah: {
    name: "Noah Whitfield",
    role: "Founding Partner, Signal Atelier",
    bio: "Noah leads product strategy and design at Signal Atelier. Previously shipped two SaaS startups from zero to Series B.",
    initials: "NW",
  },
  amara: {
    name: "Amara Kessler",
  ...
  rohan: {
    name: "Rohan Iyer",
    role: "Design Lead",
    bio: "Rohan leads visual systems and motion design across Signal Atelier engagements.",
    initials: "RI",
  },
  sasha: {
    name: "Sasha Varga",
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      { type: "quote", text: "If you can't answer 'which tool does the agent call most often, and how fast' in under ten seconds, the server isn't done.", cite: "Internal SignalOps playbook" },
  ...
  },
  {
    ...
    excerpt:
      "How Signal Atelier balances tight design tokens with the editorial flexibility a marketing site needs.",
    category: "Design",
