...
export const SERVICES = [
  ...
  },
  {
    ...
    short: "Practical AI systems designed around real business operations.",
    long: "From AI assistants and content workflows to internal knowledge systems and customer support automation, we help businesses apply AI where it creates measurable value.",
    typical: "Discovery, build, or operations partner",
    timeline: "2-6 weeks",
    pillars: [
      "AI assistants",
      "Knowledge systems",
