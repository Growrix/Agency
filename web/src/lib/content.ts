...
export const SERVICES = [
  ...
  },
  {
    slug: "mobile-apps",
    name: "Mobile Apps",
    short: "Launch sites, companion apps, and mobile-first product surfaces.",
    long: "From high-converting app launch pages to React Native companion apps and store-ready mobile experiences—built for founders who need mobile credibility without a bloated timeline.",
    typical: "Launch sprint or companion MVP",
    timeline: "4-16 weeks",
    pillars: ["App launch sites", "Companion app MVP", "Store readiness", "Mobile UX systems"],
  },
  {
    slug: "ai-business-systems",
    name: "AI Business Systems",
    short: "Practical AI assistants that save time, reduce repetitive work, and support your team.",
    long: "From your first AI assistant to a connected business AI system, we help startups, agencies, and growing businesses apply AI where it creates measurable value.",
    typical: "AI Starter → Business AI System → AI Growth Partner",
    timeline: "2-6 weeks",
    pillars: [
  ...
  },
  {
    slug: "technical-seo",
    name: "Technical SEO",
    short: "Search visibility, analytics, and Core Web Vitals setup from day one.",
    long: "One-time technical SEO, Search Console, GA4, Meta Pixel, schema markup, and performance configuration so your product gets found and measured correctly from launch.",
    typical: "Setup sprint or audit + fix",
    timeline: "3-10 days",
