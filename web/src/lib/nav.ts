export const PRIMARY_NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Business Profile Pages", href: "/products/category/business-profile-pages", description: "One-page profile templates for freelancers and local businesses." },
      { label: "Digital Business Cards", href: "/products/category/digital-business-cards", description: "Interactive vCard-style templates for contact-first funnels." },
      { label: "Newsletter Templates", href: "/products/category/newsletter-templates", description: "Reusable newsletter products for lifecycle communication." },
      { label: "Course Landing Pages", href: "/products/category/course-landing-pages", description: "Course sales pages with enrollment-focused structures." },
...
export const FOOTER_NAV = {
  ...
  Products: [
    ...
    { label: "HTML Templates", href: "/products?category=html-templates" },
    ...
    { label: "SaaS Products", href: "/products?industry=saas" },
    { label: "Ecommerce Products", href: "/products?industry=ecommerce" },
    { label: "Service Businesses", href: "/products?industry=service-business" },
  ],
  Solutions: [
