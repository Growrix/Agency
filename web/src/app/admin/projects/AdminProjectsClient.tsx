  ...
  return (
    <div className="space-y-6 p-4 sm:p-5 lg:p-6">
      <header>
        ...
        <h1 className="mt-1 font-display text-3xl tracking-tight">Client projects</h1>
        <p className="mt-1 text-sm text-text-muted">Ongoing website builds and collaborative workspaces.</p>
      </header>
