                ...
                {status === "success" && confirmation ? (
                  <div className="py-2">
                    ...
                    <p className="mt-3 text-sm leading-6 text-text-muted">
                      Booking ID {confirmation.id}. Requested time:{" "}
                      {new Date(confirmation.datetime).toLocaleString()}.
                    </p>
                  ...
                  <form onSubmit={onSubmit} className="space-y-5" aria-busy={status === "submitting"} data-ready={isHydrated ? "true" : "false"}>
                    ...
                    <div className="grid gap-5 sm:grid-cols-2">
                      <Field label="Name" required>
                        <input name="visitor_name" required className="signal-input" placeholder="Your name" />
                      </Field>
                      <Field label="Email" required>
                        <input type="email" name="visitor_email" required className="signal-input" placeholder="you@company.com" />
                      </Field>
                    </div>

                    <Field label="Phone">
                      <input name="visitor_phone" className="signal-input" placeholder="Optional" />
                    </Field>

                    <div className="grid gap-5 sm:grid-cols-2">
                      <Field label="Service interest" required>
                        <select name="service_interested_in" className="signal-input" defaultValue="" required>
                    ...
                    <Field label="What should we review?">
                      <textarea
                        name="notes"
                        rows={4}
                        className="signal-input min-h-28 resize-y py-3"
