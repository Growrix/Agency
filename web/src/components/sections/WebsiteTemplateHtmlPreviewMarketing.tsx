...
export function HtmlBusinessProfileMobilePreviewMarketing() {
  return (
    <>
      <div className="flex flex-wrap items-center gap-2">
        <DevicePhoneMobileIcon className="size-4 text-primary" aria-hidden />
      ...
      <h3 className="mt-2.5 font-display text-xl sm:text-2xl tracking-tight text-balance">
        See how your profile reads on mobile before you buy
      </h3>
      <p className="mt-2.5 text-sm leading-6 text-text-muted">
        Preview this business profile in a {HTML_MOBILE_VIEWPORT_WIDTH}px device frame — check headline hierarchy,
        contact paths, and trust sections on the screen most visitors use first.
      </p>
      ...
      <p className="mt-3.5 flex items-start gap-2 text-sm leading-6 text-text-muted">
        <SparklesIcon className="mt-0.5 size-4 shrink-0 text-primary" aria-hidden />
        <span>
          <span className="font-display text-text">Same HTML as desktop.</span> One profile, consistent brand on every
          screen.
        </span>
      </p>
    </>
