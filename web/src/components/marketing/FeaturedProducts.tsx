...
function FeaturedProductsMobile({
  ...
  return (
    <div className="home-mobile-marketing">
      <MobileMarketingSectionHeader eyebrow={eyebrow!} title={title!} description={description} />
...
export function FeaturedProducts({
  ...
  const sharedProps = { products: visibleProducts, eyebrow, title, description, ctaHref, ctaLabel, variant };
