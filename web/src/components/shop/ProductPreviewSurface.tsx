          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-[16px] border border-white/10 bg-white/[0.04] p-4">
                ...
                <div className="mt-4 h-16 rounded-[14px] bg-white/[0.06]" />
              </div>
              <div className="rounded-[16px] border border-white/10 bg-white/[0.04] p-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[240px_1fr]">
        <div className="rounded-[18px] border border-white/10 bg-white/[0.04] p-4">
          ...
          <div className="mt-6 space-y-3">
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="h-10 rounded-[14px] bg-white/[0.06]" />
            ))}
          </div>
        </div>
        <div className="grid gap-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-[18px] border border-white/10 bg-white/[0.04] p-4">
              ...
              <div className="mt-4 space-y-3">
                {[1, 2, 3].map((item) => (
                  <div key={item} className="h-14 rounded-[14px] bg-white/[0.06]" />
                ))}
              </div>
            </div>
            <div className="rounded-[18px] border border-white/10 bg-white/[0.04] p-4">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="h-20 rounded-[14px] bg-white/[0.06]" />
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {["crm_lookup", "list_invoices", "inventory_sync", "route_ticket"].map((tool) => (
              <div key={tool} className="rounded-[16px] border border-white/10 bg-black/25 p-4">
                ...
                <div className="mt-4 h-12 rounded-[12px] bg-white/[0.05]" />
              </div>
            ))}
          </div>
        </div>
    ...
    <BrowserShell>
      <div className="rounded-[18px] border border-white/10 bg-white/[0.04] p-5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="rounded-full border border-white/10 bg-white/[0.05] px-3 py-1 font-mono text-[11px] uppercase tracking-[0.2em] text-white/60">
            12 automations
          </div>
        </div>
  ...
  return (
    <BrowserShell>
      <div className="grid gap-6 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
        <div className="mx-auto w-[220px] rounded-[32px] border border-white/10 bg-black/35 p-3 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
          <div className="overflow-hidden rounded-[24px] border border-white/10 bg-linear-to-b from-[#16202a] via-[#10151f] to-[#0f1218] p-4">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="h-16 rounded-[16px] bg-white/[0.06]" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="rounded-[18px] border border-white/10 bg-white/[0.04] p-5">
          ...
          <div className="mt-5 rounded-[16px] border border-white/10 bg-black/25 p-4">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <div className="h-24 rounded-[16px] bg-white/[0.06]" />
              <div className="h-24 rounded-[16px] bg-white/[0.06]" />
            </div>
          </div>
        </div>
          ...
          <div className="rounded-[18px] border border-white/10 bg-black/25 p-4">
            ...
            <div className="mt-4 space-y-3">
              {["Deposit", "Balance", "Confirmation"].map((item) => (
                <div key={item} className="flex items-center justify-between rounded-[14px] bg-white/[0.05] px-4 py-3">
