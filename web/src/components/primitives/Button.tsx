...
const base =
  "inline-flex items-center justify-center rounded-sm font-medium tracking-tight transition-[color,background-color,border-color,box-shadow,transform] duration-200 ease-(--ease-signal) disabled:opacity-60 disabled:pointer-events-none whitespace-nowrap will-change-transform hover:-translate-y-px active:translate-y-0 active:scale-[0.97]";
